...
const settingsOptions = [
    { iconName: "person-circle-outline", label: "Account Setting", onPress: () => {} },
    ...
    { iconName: "chatbubble-ellipses-outline", label: "Contact", onPress: () => {} },
            ...
            <ScrollView contentContainerStyle={styles.content}>
                <View style={styles.box}>
                    {settingsOptions.map((item, index) => (
                        <SettingItem key={index} iconName={item.iconName} label={item.label} onPress={item.onPress} />
                    ))}

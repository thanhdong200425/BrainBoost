...
export default function HomeScreen() {
  const userData = {
    name: "Dong",
    recentlyStudied: [
      { id: 1, title: "Vocabulary A1 – A2 (ETS 2023)", time: "2 Days ago", active: true },
      { id: 2, title: "Vocabulary B1 (ETS 2023)", time: "2 Days ago", active: false },
      { id: 3, title: "Vocabulary B2 (ETS 2023)", time: "2 Days ago", active: false },
      { id: 4, title: "Vocabulary C1 (ETS 2023)", time: "2 Days ago", active: false },
    ],
    progress: [
  ...
  return (
    <ScrollView contentContainerStyle={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <UpcomingCoursesContainer courses={userData.recentlyStudied} />

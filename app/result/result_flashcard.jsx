      ...
      {[...Array(10)].map((_, i) => (
        <Animated.View
          ...
          style={{
            ...
            opacity: confettiAnim.interpolate({ inputRange: [0, 1], outputRange: [0, 1] }),
            transform: [
              { translateY: confettiAnim.interpolate({ inputRange: [0, 1], outputRange: [0, height * 0.5] }) },
              { rotate: confettiAnim.interpolate({ inputRange: [0, 1], outputRange: ['0deg', `${i * 36}deg`] }) },
            ],
          }}
        />
      ))}
      ...
      <View style={styles.container}>
        ...
        <View style={styles.buttonRow}>
          ...
          <TouchableOpacity style={styles.backButton} onPress={handleBackToDeck}>
            <Ionicons name="arrow-back" size={20} color="#3D5CFF" style={{ marginRight: 6 }} />
